  ...
  return (
    <div className="min-h-screen bg-[#191919] text-white">
      ...
      <main className="flex flex-col w-full">
        {/* Section 1: Todo tu condominio en una sola app */}
        <section className="relative w-full overflow-hidden bg-[#191919]">
          ...
          <div className="mx-auto w-full max-w-[1440px] px-6 pb-20 pt-[100px] sm:px-10">
            <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:justify-between">
              ...
              {/* Right Image (Laptop) */}
              <div className="relative w-full max-w-[843px] z-10">
                <Image
                  src="/images/condominios/laptop-home.png"
                  alt="Todo tu condominio en una sola app"
                  width={843}
                  height={640}
                  className="h-auto w-full object-contain drop-shadow-2xl"
                  priority
                />
                {/* Background Glow Effect behind laptop */}
                <div
              ...
              {/* Background Glow Effect for text area */}
              <div
                className="absolute left-[-10%] top-[30%] -translate-y-1/2 rounded-full opacity-30 blur-[100px]"
                style={{
                  background:
                    "radial-gradient(circle, #00e38e 0%, transparent 70%)",
                  width: "400px",
        ...
        {/* Section 2: Funcionalidades y reportes */}
        <section className="relative w-full h-auto overflow-hidden bg-[#191919]">
          {/* Side Glow Effect */}
          <div
            className="absolute left-0 top-1/2 h-[700px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-60 blur-[90px] pointer-events-none mix-blend-screen z-0"
            style={{
              background:
                "radial-gradient(circle, rgba(255,255,255,0.8) 0%, #00e38e 50%, rgba(0,227,142,0) 70%)",
            }}
          />
          <div className="mx-auto w-full max-w-[1440px] px-6 pt-6 sm:px-10 relative z-10 pb-0">
            <div className="flex flex-col items-center gap-12 text-center">
              ...
              <div className="relative w-full flex flex-col items-center justify-center gap-8 lg:flex-row lg:items-center">
                ...
                <div className="flex flex-col gap-12 text-center lg:w-1/4 lg:text-right">
                  <div className="flex flex-col gap-2">
                    ...
                    <span className="text-[14px] text-gray-300">
                      Visualiza, crea, modifica y elimina usuarios del
                      condominio.
                    </span>
                  </div>
                  <div className="flex flex-col gap-2">
                    ...
                    <span className="text-[14px] text-gray-300">
                      Registra y controla todos los movimientos de dinero de tu
                      condominio.
                    </span>
                  </div>
                </div>
                ...
                {/* Center Image (Laptop) */}
                <div className="relative w-full max-w-[843px] z-10 lg:w-1/2">
                  <Image
                    src="/images/condominios/laptop-home.png"
                    alt="Funcionalidades y reportes"
                    width={843}
                    height={640}
                    className="h-auto w-full object-contain drop-shadow-2xl"
                  />
                ...
                <div className="flex flex-col gap-12 text-center lg:w-1/4 lg:text-left">
                  <div className="flex flex-col gap-2">
                    ...
                    <span className="text-[14px] text-gray-300">
                      Visualiza y gestiona las deudas de tus residentes de forma
                      eficiente.
                    </span>
                  </div>
                  <div className="flex flex-col gap-2">
                    ...
                    <span className="text-[14px] text-gray-300">
                      Gestiona y comparte documentos importantes de forma segura
                      y organizada.
                    </span>
                  </div>
                </div>
